...
func healHero_Driver(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodDelete {
		fmt.Fprintf(w, module.GCFHandlerDeleteDriver("PASETOPUBLICKEY", "MONGOSTRING", "healhero_db", r))
		return
	}
	// Set CORS headers for the main request.
	fmt.Fprintf(w, module.GCFHandlerGetDriver("PASETOPUBLICKEY", "MONGOSTRING", "healhero_db", r))
}